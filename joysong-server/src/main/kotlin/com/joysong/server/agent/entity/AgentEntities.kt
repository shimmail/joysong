...
class AgentUserProfileEntity(
    ...
    var city: String = "",
    @Column(name = "goals_json", columnDefinition = "TEXT") var goalsJson: String = "[]",
    ...
    @Column(name = "preferences_json", columnDefinition = "TEXT") var preferencesJson: String = "[]",
    @Column(name = "excluded_projects_json", columnDefinition = "TEXT") var excludedProjectsJson: String = "[]",
...
class AgentAssessmentEntity(
    ...
    @Column(name = "goal_snapshot_json", columnDefinition = "TEXT") var goalSnapshotJson: String,
    @Column(name = "risk_level") var riskLevel: String,
    @Column(name = "risk_reasons_json", columnDefinition = "TEXT") var riskReasonsJson: String,
    @Column(name = "missing_fields_json", columnDefinition = "TEXT") var missingFieldsJson: String,
    @Column(name = "created_at") var createdAt: LocalDateTime = LocalDateTime.now()
)
...
class AgentPlanItemEntity(
    ...
    @Column(name = "risks_json", columnDefinition = "TEXT") var risksJson: String,
    @Column(name = "alternatives_json", columnDefinition = "TEXT") var alternativesJson: String,
    @Column(name = "required_confirmation_json", columnDefinition = "TEXT") var requiredConfirmationJson: String,
...
class AgentSafetyEventEntity(
    ...
    @Column(name = "risk_level") var riskLevel: String,
    @Column(name = "evidence_json", columnDefinition = "TEXT") var evidenceJson: String,
...
@Entity
@Table(name = "agent_tool_audits")
class AgentToolAuditEntity(
    @Id var id: String,
    @Column(name = "user_id") var userId: String,
