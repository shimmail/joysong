...
enum class OrderStatusEnum(val value: String) {
    ...
    companion object {
        ...
        val TRANSITION_MAP: Map<OrderStatusEnum, Set<OrderStatusEnum>> = mapOf(
            ...
            SERVICE_ACTIVE to setOf(COMPLETED, REFUND_REVIEW),
            REFUND_REVIEW to setOf(SERVICE_ACTIVE, COMPLETED, REFUND_PROCESSING),
            ...
            COMPLETED to setOf(PENDING_SETTLEMENT, DISPUTE_MEDIATION, REFUND_REVIEW),
