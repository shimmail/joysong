...
class OrderService(
    ...
    fun createOrder(userId: String, request: CreateOrderRequest): OrderResponse {
        ...
        val order = OrderEntity(
            ...
            totalAmountMinor = Money.toMinor(discountedPrice, "CNY"),
            paidAmount = BigDecimal.ZERO,
            paidAmountMinor = 0,
            couponId = couponId,
            userCouponId = userCouponId,
            discountAmount = discountAmount,
            discountAmountMinor = Money.toMinor(discountAmount, "CNY"),
            ...
            consultationFeeMinor = Money.toMinor(consultationFee, "CNY"),
            remainingAmount = remainingAmount,
            remainingAmountMinor = Money.toMinor(remainingAmount, "CNY"),
            pricingCountry = "CN",
